...
function initApp() {
    ...
    tabBtns.forEach(btn => {
        btn.onclick = function() {
            ...
            if (target === 'tiktok') {
                ...
                if (bgremoverSection) bgremoverSection.classList.add('hidden');
            } else {
                if (tiktokSection) tiktokSection.classList.add('hidden');
                if (bgremoverSection) bgremoverSection.classList.remove('hidden');
            }
        };
    });
    ...
    if (processTiktokBtn) {
        processTiktokBtn.onclick = downloadVideo;
    }

    // Tombol Proses Remove Background
    if (processBgBtn) {
        processBgBtn.onclick = removeBackground;
    }
}
