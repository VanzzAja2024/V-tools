...
function startApp() {
    ...
    // Trik aman membuka tautan WhatsApp di tab baru tanpa diblokir browser HP
    ...
    // Paksa sembunyikan halaman login dan tampilkan dashboard menggunakan inline style (Bebas dari cache CSS)
...
function checkLoginState() {
    const hasStarted = localStorage.getItem('hasStarted') === 'true' || sessionStorage.getItem('hasStarted') === 'true';
    const authPage = document.getElementById('authPage');
    const dashboardPage = document.getElementById('dashboardPage');
